...
export default function DoctorHeroSection({ onOpenDetails }: DoctorHeroSectionProps) {
  return (
    ...
    >
      {/* ========================================================================= */}
      {/* TOP ROW: INFO (LEFT) & LARGE DOCTOR PHOTO (RIGHT) - SIDE-BY-SIDE ON ALL   */}
      {/* ========================================================================= */}
      <div className="flex items-start justify-between gap-3 sm:gap-6">
        ...
        {/* Right Photo Column (Doctor Photo + Details Button Directly Below) */}
        <div className="flex flex-col items-center shrink-0">
          
          {/* Doctor Portrait */}
          <div className="relative w-28 h-36 sm:w-44 sm:h-52 rounded-2xl sm:rounded-3xl overflow-hidden bg-white border-2 sm:border-4 border-white shadow-md">
            <img
      ...
      {/* ========================================================================= */}
      {/* BOTTOM ROW: GET CLARITY IN JUST 5 MINUTES OFFER BOX                       */}
      {/* ========================================================================= */}
      <div className="mt-3 sm:mt-4 p-3 sm:py-3.5 sm:px-4 rounded-2xl bg-white/95 backdrop-blur-sm border border-[#F0DCBA] shadow-xs flex items-center justify-between gap-2 sm:gap-4 w-full">
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-xs sm:text-sm font-bold text-[#23150D] truncate leading-tight">
              Get Clarity in Just 5 Minutes
            </p>
            <p className="text-[10px] sm:text-[11px] text-[#5C4D44] truncate leading-tight mt-0.5">
        ...
        {/* Right: Price */}
        <div className="text-center shrink-0 min-w-[70px] sm:min-w-[85px]">
